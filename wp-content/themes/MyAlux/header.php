...
?>
<?php
$metaGeneratorContent = 'www.myalux.com';
$meta_generator = '';
...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'myalux' ); ?></a>
    <?php if (!$hideHeader) { ?>
    <header class="u-clearfix u-header u-header" id="sec-d7ff">
  <div class="u-clearfix u-sheet u-sheet-1">
    <?php $logo = theme_get_logo(array(
            'default_src' => "/images/logo_3.jpg",
            'default_url' => home_url('/'),
            'default_width' => '176'
        )); ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo esc_url($logo['url']); ?>" class="u-border-2 u-border-grey-75 u-image u-image-circle u-logo u-image-1 custom-logo-link" data-image-width="1600" data-image-height="383" title="MyAlux">
      <img <?php if ($logo['svg']) {echo 'style="width:'.$logo['width'].'px"';} else {echo 'style="width:auto"';}?>src="<?php echo esc_url($logo['src']); ?>" class="u-logo-image u-logo-image-1" data-image-width="176.075">
    </a>
    <?php
            ob_start();
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'link_class' => 'u-button-style u-nav-link u-text-active-palette-3-base u-text-hover-palette-1-base u-text-white',
                    'link_style' => 'padding: 10px 20px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-c06b-19',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => 'padding: 10px 20px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-c06b-20',
                    'submenu_item_class' => 'u-nav-item',
