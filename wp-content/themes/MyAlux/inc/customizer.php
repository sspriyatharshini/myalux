...
function theme_customize_register($wp_customize) {
    ...
    for ($i = 1; $i <= 5; $i++) {
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_$i", array(
            'label' => sprintf(__('Color %s', 'myalux'), $i),
            'section' => 'colors',
        )));
    }
    ...
    $wp_customize->add_control('typography_scheme', array(
        'label' => __('Typography Scheme', 'myalux'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('typography_heading_weight', array(
        'label' => __('Heading Weight', 'myalux'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(
            '100' => __('100 Thin', 'myalux'),
            '300' => __('300 Light', 'myalux'),
            '400' => __('400 Regular', 'myalux'),
            '500' => __('500 Medium', 'myalux'),
            '700' => __('700 Bold', 'myalux'),
            '900' => __('900 Black', 'myalux'),
        ),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_width', array(
        'type' => 'number',
        'label' => __('Logo max width (px)', 'myalux'),
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_height', array(
        'type' => 'number',
        'label' => __('Logo max height (px)', 'myalux'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_link', array(
        'type' => 'url',
        'label' => __('Logo link href', 'myalux'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'custom_favicon', array(
        'label' => __('Favicon', 'myalux'),
        'section' => 'title_tagline',
        'priority' => 8,
        'height' => '64',
        'width' => '64',
        'button_labels' => array(
            'select' => __('Select favicon', 'myalux'),
            'change' => __('Change favicon', 'myalux'),
            'remove' => __('Remove', 'myalux'),
            'default' => __('Default', 'myalux'),
            'placeholder' => __('No favicon selected', 'myalux'),
            'frame_title' => __('Select favicon', 'myalux'),
            'frame_button' => __('Choose favicon', 'myalux'),
        ),
    )));
    ...
    $wp_customize->add_control('menu_trim_title', array(
        ...
        'label' => __('Trim long menu items', 'myalux'),
    ));
    ...
    $wp_customize->add_control('menu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each item to [N] characters', 'myalux'),
    ));
    ...
    $wp_customize->add_control('submenu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each subitem to [N] characters', 'myalux'),
    ));
    ...
    $wp_customize->add_control('menu_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Apply menu item tag filter', 'myalux'),
    ));
    ...
    $wp_customize->add_control('menu_allowed_tags', array(
        'type' => 'text',
        'section' => 'menu_options',
        'label' => __('Allowed menu item tags', 'myalux'),
    ));
    ...
    $wp_customize->add_control('use_default_menu', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Use not stylized menu', 'myalux'),
        'description' => __('Used standart wp_nav_menu when option is enabled (need for some third-party plugins).', 'myalux'),
    ));
    ...
    $wp_customize->add_control('excerpt_auto', array(
        ...
        'label' => __('Use auto excerpts', 'myalux'),
        'description' => __('Generate post excerpts automatically (When neither more-tag nor post excerpt is used)', 'myalux'),
    ));
    ...
    $wp_customize->add_control('excerpt_words', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt length (words)', 'myalux'),
    ));
    ...
    $wp_customize->add_control('excerpt_min_remainder', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt balance (words)', 'myalux'),
    ));
    ...
    $wp_customize->add_control('excerpt_strip_shortcodes', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Remove shortcodes from excerpt', 'myalux'),
    ));
    ...
    $wp_customize->add_control('excerpt_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Apply excerpt tag filter', 'myalux'),
    ));
    ...
    $wp_customize->add_control('excerpt_allowed_tags', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('Allowed excerpt tags', 'myalux'),
    ));
    ...
    $wp_customize->add_control('show_morelink', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Show More Link', 'myalux'),
    ));
    ...
    $wp_customize->add_control('morelink_template', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('More Link Template', 'myalux'),
        'description' => sprintf(__('ShortTags: %s', 'myalux'), '[url], [text]'),
    ));
    ...
    $wp_customize->add_control('seo_og', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include Open Graph meta tags', 'myalux'),
    ));
    ...
    $wp_customize->add_control('seo_ld', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include schema.org JSON-LD syntax markup', 'myalux'),
    ));
        ...
        foreach ($theme_options as $op) {
            if (isset($op['options'])) {
                foreach ($op['options'] as $key => $option) {
                    foreach ($templates as $temlateName) {
                        if (strpos($key, $temlateName . 'Template') === 0) {
                            if (!isset($templatesOptions[$temlateName])) {
                                $templatesOptions[$temlateName] = array();
                            }
                            $templatesOptions[$temlateName][$key] = __($option, 'myalux');
                        }
                    }
                }
            }
    ...
    $wp_customize->add_setting('theme_template_'.$template.'_blog-template', array(
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
        'default' => $theme_default_options['theme_template_'.$template.'_blog-template'],
    ));
    $wp_customize->add_control('theme_template_'.$template.'_blog-template', array(
        'type' => 'select',
        'choices' => $templatesOptions['blog'],
        'section' => 'templates_options',
        'label' => __('Blog Template', 'myalux'),
        'description' => '',
    ));

    $wp_customize->add_setting('theme_template_'.$template.'_post-template', array(
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
        'default' => $theme_default_options['theme_template_'.$template.'_post-template'],
    ));
    $wp_customize->add_control('theme_template_'.$template.'_post-template', array(
        'type' => 'select',
        'choices' => $templatesOptions['post'],
        'section' => 'templates_options',
        'label' => __('Post Template', 'myalux'),
        'description' => '',
    ));

    if (theme_woocommerce_enabled()) {
        $wp_customize->add_setting('theme_template_'.$template.'_products-template', array(
            'capability' => 'edit_theme_options',
            'sanitize_callback' => 'sanitize_text_field',
            'default' => $theme_default_options['theme_template_'.$template.'_products-template'],
        ));
        $wp_customize->add_control('theme_template_'.$template.'_products-template', array(
            'type' => 'select',
            'choices' => $templatesOptions['products'],
            'section' => 'templates_options',
            'label' => __('Products Template', 'myalux'),
            'description' => '',
        ));
        $wp_customize->add_setting('theme_template_'.$template.'_product-template', array(
            'capability' => 'edit_theme_options',
            'sanitize_callback' => 'sanitize_text_field',
            'default' => $theme_default_options['theme_template_'.$template.'_product-template'],
        ));
        $wp_customize->add_control('theme_template_'.$template.'_product-template', array(
            'type' => 'select',
            'choices' => $templatesOptions['product'],
            'section' => 'templates_options',
            'label' => __('Product Template', 'myalux'),
            'description' => '',
        ));
        $wp_customize->add_setting('theme_template_'.$template.'_shopping-cart-template', array(
            'capability' => 'edit_theme_options',
            'sanitize_callback' => 'sanitize_text_field',
            'default' => $theme_default_options['theme_template_'.$template.'_shopping-cart-template'],
        ));
        $wp_customize->add_control('theme_template_'.$template.'_shopping-cart-template', array(
            'type' => 'select',
            'choices' => $templatesOptions['shoppingCart'],
            'section' => 'templates_options',
            'label' => __('Shopping Cart Template', 'myalux'),
            'description' => '',
        ));

        $wp_customize->add_setting('theme_template_'.$template.'_404-template', array(
            'capability' => 'edit_theme_options',
            'sanitize_callback' => 'sanitize_text_field',
            'default' => $theme_default_options['theme_template_'.$template.'_404-template'],
        ));
        $wp_customize->add_control('theme_template_'.$template.'_404-template', array(
            'type' => 'select',
            'choices' => $templatesOptions['page404'],
            'section' => 'templates_options',
            'label' => __('404 Template', 'myalux'),
            'description' => '',
        ));
    }
    ...
    $wp_customize->add_section('other_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Other settings', 'myalux'),
        'priority' => 200,
    ));
    ...
    $wp_customize->add_control('include_jquery', array(
        ...
        'label' => __('Use jQuery from theme', 'myalux'),
    ));
    ...
    $wp_customize->add_section('sidebar_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Sidebars', 'myalux'),
        'priority' => 100,
    ));

    $layouts_choices = array(
        '' => __('Default', 'myalux'),
        'left-sidebar' => __('Left', 'myalux'),
        'right-sidebar' => __('Right', 'myalux'),
        'none' => __('None', 'myalux'),
    );
    ...
    $wp_customize->add_control('sidebars_layout_blog', array(
        ...
        'label' => __('Blog Template', 'myalux'),
        'description' => __('Templates for displaying blogs, archives, search results', 'myalux'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_post', array(
        ...
        'section' => 'sidebar_options',
        'label' => __('Post Template', 'myalux'),
        'description' => __('Templates for displaying single posts', 'myalux'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_default', array(
        ...
        'choices' => $layouts_choices,
        'section' => 'sidebar_options',
        'label' => __('Default Template', 'myalux'),
        'description' => __('Templates for displaying single pages and everything else', 'myalux'),
    ));
}
add_action('customize_register', 'theme_customize_register', 11);

function theme_print_sidebars_blog_caption() {
    printf('<h3>%s</h3>', __('Display sidebars on:', 'myalux'));
}
